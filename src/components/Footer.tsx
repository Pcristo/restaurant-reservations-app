...
export default function Footer() {
  ...
  return (
    <footer className={cn(
      ...
      <div className={cn("relative mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16", settings?.containerWidth === '1480px' && location.pathname !== '/' ? "w-full max-w-[1480px]" : "w-full max-w-[1267px]")}>
